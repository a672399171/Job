        ...
        <table class="table table-hover">
            ...
            <tr ng-repeat="item in applies">
                ...
                <td>
                    ...
                    <span class="label label-danger" ng-if="item.state==1">已回绝</span>
                    <span class="label label-success" ng-if="item.state==2">已接收</span>
                </td>
                <td>
                    <span ng-if="item.state==0">
                        <a href="javascript:void(0)" ng-click="updateApply(item,1)">回绝</a>
                        <a href="javascript:void(0)" ng-click="updateApply(item,2)">接收</a>
                    </span>
                    <a href="javascript:void(0)" ng-click="openDlg(item.resume.id)">查看简历</a>
                </td>
            </tr>
            </tbody>
        </table>
    </div>
    <nav style="margin: 0 auto;text-align: center" ng-if="applies.length > 0">
